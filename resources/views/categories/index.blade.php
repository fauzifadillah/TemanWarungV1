...
<div class="row" style="padding-top:15px;">
  <div class="col-lg-12">
    <div class="card">
      <div class="card-body">
        <h3 class="mb-3"><strong>Category</strong>
          <a href="{{ route('category.create') }}" class="btn btn-primary float-right btn-sm modal-show" name="Add Category"><i class="nav-icon fas fa-plus"></i> Add New</a>
        </h3>
